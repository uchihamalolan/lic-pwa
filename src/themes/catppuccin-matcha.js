...
/**
 * catppuccin-matcha theme — built by `pnpm exec astryx theme build`
 * Import the CSS file alongside this module:
 *
 *   import { catppuccinMatchaTheme } from './catppuccin-matcha';
 *   import './catppuccin-matcha.css';
 */
export const catppuccinMatchaTheme = {
  ...
  tokens: {
    ...
    "--color-accent":
      "light-dark(oklch(0.5546698483756871 0.25034607990295016 297.0156483500495), oklch(0.7871462525760659 0.11867011135986587 304.7693043767238))",
    "--color-accent-muted":
      "light-dark(oklch(0.8574770848204982 0.014479984436494493 268.47559171847894), oklch(0.3240218874463015 0.03188455239399239 281.9784417412653))",
    "--color-neutral": "light-dark(#3E481D0F, #C0CBA91A)",
    "--color-background-surface":
      "light-dark(oklch(0.905964995559709 0.011716507677813338 264.50710516682375), oklch(0.18278246200466305 0.02037484440642812 284.2038483902186))",
    "--color-background-body":
      "light-dark(oklch(0.9577608870760925 0.005766802410310334 264.532151644555), oklch(0.24286694183838442 0.03035736275944967 283.91097023641396))",
    ...
    "--color-background-muted":
      "light-dark(oklch(0.8574770848204982 0.014479984436494493 268.47559171847894), oklch(0.3240218874463015 0.03188455239399239 281.9784417412653))",
    "--color-text-primary":
      "light-dark(oklch(0.4354696280914242 0.043007957904862906 279.325020951234), oklch(0.8786600793473718 0.04255199903517194 272.2767378415369))",
    "--color-text-secondary":
      "light-dark(oklch(0.5470776379676476 0.034342788375285344 279.0836971153176), oklch(0.7509605472605528 0.03956498596177885 273.9319903727045))",
    ...
    "--color-background-card":
      "light-dark(oklch(0.9334593324109276 0.00871379906203183 264.52060223534073), oklch(0.2155216079500624 0.02541687089919072 284.06469902193265))",
    "--color-background-popover": "light-dark(#FFFFFF, #3E481D)",
    "--color-background-inverted": "light-dark(#3E481D, #C0CBA9)",
    "--color-success":
      "light-dark(oklch(0.6250443904295363 0.17715816108762134 140.44483759142634), oklch(0.8577042231793516 0.109228579658491 142.71528901553893))",
    "--color-success-muted": "light-dark(#4D990020, #6dbf2a20)",
    "--color-error":
      "light-dark(oklch(0.5504744142539229 0.21551430760195764 19.809464044160393), oklch(0.7555920111610426 0.12970214251394938 2.76416484470991))",
    "--color-error-muted": "light-dark(#FD000020, #ff5c5c20)",
    "--color-warning":
      "light-dark(oklch(0.7139917309504697 0.14944164080684152 67.77665534753208), oklch(0.9193028538212243 0.07041462719493903 86.52808223272405))",
    "--color-warning-muted": "light-dark(#FFB60020, #ffc94020)",
    "--color-border":
      "light-dark(oklch(0.8574770848204982 0.014479984436494493 268.47559171847894), oklch(0.3240218874463015 0.03188455239399239 281.9784417412653))",
    "--color-border-emphasized":
      "light-dark(oklch(0.8083070110182754 0.01739330880861526 271.1981554317899), oklch(0.4036914196944409 0.03195464132822365 280.1520036072935))",
